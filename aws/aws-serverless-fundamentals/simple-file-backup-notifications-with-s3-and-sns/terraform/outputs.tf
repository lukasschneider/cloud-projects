...
output "email_subscriptions" {
  description = "List of email adresses subscribed to backup_notifications"
...
output "upload_command_example" {
  ...
  value       = "aws s3 cp test-backup.txt s3://${aws_s3_bucket.backup_bucket.bucket}/ --recursive"
}
...
output "lifecycle_expiration_days" {
  description = "Number of days after whcih backup files will be automatically deleted (0 = disabled)"
